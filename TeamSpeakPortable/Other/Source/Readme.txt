...
user in an INI file next to TeamSpeakPortable.exe called TeamSpeakPortable.ini.
...
copy AppNamePortable.ini from this directory to TeamSpeakPortable.ini next to
TeamSpeakPortable.exe. The options in the INI file are as follows:
